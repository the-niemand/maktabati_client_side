...
const Dash_NewUser = () => {
     ...
     const handleCreatingUser = async (e) => {
          ...
          if (firstname, email, lastname, password, passwordConfirmation) {
               try {
                    ...
                    const fetch_url = `${URL}users/register`;
                         ...
                         <div className="relative bg-white shadow-search rounded p-16 w-2/4">
                              ...
                              <form onSubmit={handleSubmit} className='flex flex-col gap-6'>
                                   ...
                                   <div className="w-full mt-6">
                                        <button onClick={handleCreatingUser} className="w-full px-6 border-2 border-yellow-400 bg-yellow-400 text-white py-1.5 rounded-md hover:bg-transparent hover:text-yellow-400 font-semibold transition ease-out duration-250" >
                                             Create
                                        </button>
                                   </div>
                              </form>
